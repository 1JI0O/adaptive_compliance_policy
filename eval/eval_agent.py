...
class SingleArmAgent:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.robot.robot.SetCartesianImpedance([10000, 10000, 10000, 500, 500, 500], [0.7, 0.7, 0.7, 0.7, 0.7, 0.7])
        self.robot.robot.SetMaxContactWrench([50, 50, 50, 3, 3, 3])
